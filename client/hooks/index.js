...
export const useProvideAuth = () => {
  ...
  const register = async (formData) => {
    ...
    try {
      const { data } = await axios.post(
        'https://airbnb-backend-r81v.onrender.com/user/register',
        {
          name,
          email,
          password,
  ...
  const login = async (formData) => {
    ...
    try {
      const { data } = await axios.post(
        'https://airbnb-backend-r81v.onrender.com/user/login',
        {
          email,
          password,
        },
  ...
  const googleLogin = async (credential) => {
    ...
    try {
      const { data } = await axios.post(
        'https://airbnb-backend-r81v.onrender.com/user/google/login',
        {
  ...
  const logout = async () => {
    try {
      const { data } = await axios.get(
        'https://airbnb-backend-r81v.onrender.com/user/logout',
      );
      if (data.success) {
        setUser(null);
  ...
  const uploadPicture = async (picture) => {
    try {
      ...
      const { data } = await axios.post(
        'https://airbnb-backend-r81v.onrender.com/user/upload-picture',
        formData,
        {
  ...
  const updateUser = async (userDetails) => {
    ...
    try {
      const { data } = await axios.put(
        'https://airbnb-backend-r81v.onrender.com/user/update-user',
        {
          name,
          password,
          email,
...
export const useProvidePlaces = () => {
  ...
  const getPlaces = async () => {
    const { data } = await axios.get(
      'https://airbnb-backend-r81v.onrender.com/places',
    );
